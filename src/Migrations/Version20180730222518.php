 ...
 */
final class Version20180730222518 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD nom_complet VARCHAR(100) NOT NULL, ADD mail VARCHAR(15) NOT NULL, DROP structure, DROP adresse, CHANGE telephone telephone VARCHAR(100) NOT NULL');
    }
