...
// Returns the private 'App\Repository\ProprietaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProprietaireRepository.php';

return $this->privates['App\Repository\ProprietaireRepository'] = new \App\Repository\ProprietaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
