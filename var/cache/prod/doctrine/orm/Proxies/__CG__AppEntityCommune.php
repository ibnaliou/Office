...
class Commune extends \App\Entity\Commune implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Commune' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Commune' . "\0" . 'nomCom', '' . "\0" . 'App\\Entity\\Commune' . "\0" . 'departement', '' . "\0" . 'App\\Entity\\Commune' . "\0" . 'arrondissements'];
        }
    ...
    public function getNomCom(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomCom', []);
     ...
     * {@inheritDoc}
     */
    public function setNomCom(string $nomCom): \App\Entity\Commune
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomCom', [$nomCom]);
     ...
     * {@inheritDoc}
     */
    public function setDepartement(?\App\Entity\Departement $departement): \App\Entity\Commune
    {
     ...
     * {@inheritDoc}
     */
    public function removeArrondissement(\App\Entity\Arrondissement $arrondissement): \App\Entity\Commune
    {
