...
// Returns the private 'App\Repository\JourRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/JourRepository.php';

return $this->privates['App\Repository\JourRepository'] = new \App\Repository\JourRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
