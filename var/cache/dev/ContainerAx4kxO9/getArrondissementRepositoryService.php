...
// Returns the private 'App\Repository\ArrondissementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ArrondissementRepository.php';

return $this->privates['App\Repository\ArrondissementRepository'] = new \App\Repository\ArrondissementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
