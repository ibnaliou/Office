...
// Returns the private 'App\Repository\DepartementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DepartementRepository.php';

return $this->privates['App\Repository\DepartementRepository'] = new \App\Repository\DepartementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
