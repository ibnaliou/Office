...
// Returns the private 'App\Repository\TypedebienRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TypedebienRepository.php';

return $this->privates['App\Repository\TypedebienRepository'] = new \App\Repository\TypedebienRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
