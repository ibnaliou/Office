...
// Returns the private 'App\Repository\CArrondissementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CArrondissementRepository.php';

return $this->privates['App\Repository\CArrondissementRepository'] = new \App\Repository\CArrondissementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
