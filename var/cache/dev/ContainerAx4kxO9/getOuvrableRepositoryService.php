...
// Returns the private 'App\Repository\OuvrableRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\OuvrableRepository.php';

return $this->privates['App\Repository\OuvrableRepository'] = new \App\Repository\OuvrableRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
