...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\AjoutBienType' => function () {
    return ($this->privates['App\Form\AjoutBienType'] ?? $this->load('getAjoutBienTypeService.php'));
}, 'App\\Form\\BienType' => function () {
    return ($this->privates['App\Form\BienType'] ?? $this->privates['App\Form\BienType'] = new \App\Form\BienType());
}, 'App\\Form\\ClientType' => function () {
    return ($this->privates['App\Form\ClientType'] ?? $this->privates['App\Form\ClientType'] = new \App\Form\ClientType());
}, 'App\\Form\\CommentaireType' => function () {
    return ($this->privates['App\Form\CommentaireType'] ?? $this->privates['App\Form\CommentaireType'] = new \App\Form\CommentaireType());
}, 'App\\Form\\JourType' => function () {
    return ($this->privates['App\Form\JourType'] ?? $this->privates['App\Form\JourType'] = new \App\Form\JourType());
}, 'App\\Form\\ProprietaireType' => function () {
    return ($this->privates['App\Form\ProprietaireType'] ?? $this->privates['App\Form\ProprietaireType'] = new \App\Form\ProprietaireType());
}, 'App\\Form\\ReservationType' => function () {
    return ($this->privates['App\Form\ReservationType'] ?? $this->privates['App\Form\ReservationType'] = new \App\Form\ReservationType());
